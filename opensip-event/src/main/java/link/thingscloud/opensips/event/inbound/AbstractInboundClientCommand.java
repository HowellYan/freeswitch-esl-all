...
import link.thingscloud.opensips.event.builder.Command;
import link.thingscloud.opensips.event.inbound.option.OutboundClientOption;

import java.util.List;
import java.util.Map;

import static link.thingscloud.opensips.event.builder.Command.*;
...
abstract class AbstractInboundClientCommand extends AbstractInboundClient {
    ...
    AbstractInboundClientCommand(OutboundClientOption option) {
        super(option);
    }
